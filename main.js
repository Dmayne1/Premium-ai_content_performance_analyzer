...
/**
 * AI Content Performance & SEO Intelligence Scraper
...
Actor.main(async () => {
    console.log('🚀 Starting AI Content Performance & SEO Intelligence Scraper');
    ...
    const finalReport = {
        ...
        scraperInfo: {
            name: 'AI Content Performance & SEO Intelligence Scraper',
            version: '2.0.0',
